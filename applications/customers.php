...
class customers_app extends application 
{
	...
	{
		$this->application("orders", _($this->help_context = "&Accounts"));
		...
		$this->add_lapp_function(0, _("&Deposit"),
			"sales/cashdeposit.php?NewOrder=Yes", 'SA_SALESORDER', MENU_TRANSACTION);
		...
		$this->add_lapp_function(1, _("Transaction &Inquiry"),
			"ics/inquiry/txnhist.php?", 'SA_SALESTRANSVIEW', MENU_INQUIRY);
		$this->add_lapp_function(1, _("Unauthorized Maintenance &Inquiry"),
				"ics/inquiry/unauthorized.php?", 'SA_SALESTRANSVIEW', MENU_INQUIRY);
		...
		$this->add_rapp_function(1, _("Customer &Reports"),
			"reporting/reports_main.php?Class=0", 'SA_SALESTRANSVIEW', MENU_REPORT);

		$this->add_module(_("Maintenance"));
		$this->add_lapp_function(2, _("Add New &Customer"),
			"ics/manage/newcust.php?", 'SA_CUSTOMER', MENU_ENTRY);
		$this->add_lapp_function(2, _("Customer &Maintenance"),
			"ics/manage/custmaint.php?", 'SA_CUSTOMER', MENU_ENTRY);
			$this->add_lapp_function(2, _("New Account &Opening"),
			"ics/manage/newacct.php?", 'SA_CUSTOMER', MENU_ENTRY);
		$this->add_lapp_function(2, _("Account &Maintenance"),
			"ics/inquiry/acctsearch.php?", 'SA_CUSTOMER', MENU_ENTRY);
