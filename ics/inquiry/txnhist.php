...
if ($trans_type == ST_SALESORDER)
{
    ...
    $_SESSION['page_title'] = _($help_context = "Transaction History");
...
$sql = get_sql_for_txnhist( @$selected_stock_item, @$_POST['OrdersAfterDate'], @$_POST['OrdersToDate']);

if ($trans_type == ST_SALESORDER)
    $cols = array(

        // a.dat_txn, a.trans_id, a.txn_desc, a.dat_value, a.amt_txn, b.acct_no, b.acct_title,
        _("Tran Date ") =>array('type'=>'date', 'ord'=>''),
        _("Value Date ") =>array('type'=>'date', 'ord'=>''),
        _("Tran reference") => array('fun'=>'view_link'),
        _("Tran Amount") => array('ord' => '') ,
        _("Tran Description"),
        _("Dr/Cr") => array('ord' => '') ,
        _("Account #")  ,
        _("Account Title")
